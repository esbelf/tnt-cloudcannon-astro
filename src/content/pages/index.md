...
content_blocks:
  - _bookshop_name: results
    ...
    heading_content: 'START WITH<br /> <span class="text-[#F0806D]">UNMATCHED</span> RESULTS'
    subheading_content: >-
    ...
    content_blocks:
      - _bookshop_name: result-content-block
        ...
        oversize_num: 1200
        oversize_text: <span class="text-[#F0806D] text-7xl">+</span>
      ...
      - _bookshop_name: result-content-block
        ...
        oversize_num: 13
        oversize_text: <span class="text-[#F0806D] text-7xl">.</span>1
      ...
      - _bookshop_name: result-content-block
        ...
        oversize_num: 17
        oversize_text: <span class="text-[#F0806D] text-7xl">x</span>
  ...
  - _bookshop_name: title-image-block
    ...
    main_text_color: "#fff"
    heading_content: BUILD STRONG <span class="text-[#F0806D]">RELATIONSHIPS</span>
    subheading_content: >-
